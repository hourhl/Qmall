...
type RPCClient interface {
	...
	VerifyUser(ctx context.Context, Req *user.VerifyUserReq, callOptions ...callopt.Option) (r *user.VerifyUserResp, err error)
}
...
func (c *clientImpl) VerifyUser(ctx context.Context, Req *user.VerifyUserReq, callOptions ...callopt.Option) (r *user.VerifyUserResp, err error) {
	return c.kitexClient.VerifyUser(ctx, Req, callOptions...)
}
