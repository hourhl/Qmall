...
func (x *VerifyUserReq) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_VerifyUserReq[number], err)
}

func (x *VerifyUserReq) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.UserId, offset, err = fastpb.ReadInt32(buf, _type)
	return offset, err
}

func (x *VerifyUserReq) fastReadField2(buf []byte, _type int8) (offset int, err error) {
	x.Token, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}

func (x *VerifyUserResp) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_VerifyUserResp[number], err)
}

func (x *VerifyUserResp) fastReadField1(buf []byte, _type int8) (offset int, err error) {
...
func (x *VerifyUserReq) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *VerifyUserReq) fastWriteField1(buf []byte) (offset int) {
	if x.UserId == 0 {
		return offset
	}
	offset += fastpb.WriteInt32(buf[offset:], 1, x.GetUserId())
...
func (x *VerifyUserReq) fastWriteField2(buf []byte) (offset int) {
	if x.Token == "" {
		return offset
	}
...
func (x *VerifyUserResp) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *VerifyUserResp) fastWriteField1(buf []byte) (offset int) {
	if !x.Res {
		return offset
	}
...
func (x *VerifyUserReq) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *VerifyUserReq) sizeField1() (n int) {
	if x.UserId == 0 {
		return n
	}
	n += fastpb.SizeInt32(1, x.GetUserId())
...
func (x *VerifyUserReq) sizeField2() (n int) {
	if x.Token == "" {
		return n
	}
...
func (x *VerifyUserResp) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *VerifyUserResp) sizeField1() (n int) {
	if !x.Res {
		return n
	}
...
var fieldIDToName_VerifyUserReq = map[int32]string{
	1: "UserId",
	2: "Token",
}

var fieldIDToName_VerifyUserResp = map[int32]string{
	1: "Res",
}
